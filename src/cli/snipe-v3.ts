...
import { fetchPumpTokenInfo, buyOnPumpFunV3, multiBuyOnPumpFunV3 } from '../trading/pump-fun-v3.js';

async function main() {
  const args = process.argv.slice(2);
  
  if (args.length < 2) {
    console.log('Usage: npx tsx src/cli/snipe-v3.ts <TOKEN_MINT> <SOL_PER_WALLET>');
    console.log('Example: npx tsx src/cli/snipe-v3.ts HJy79ZaCzFNG8Toq1PBseHGnBeZf8sktvuC3sCSZpump 0.005');
    process.exit(1);
  }
  ...
  console.log('\n🎯 Pump.fun Bonding Curve Sniper v3\n');
